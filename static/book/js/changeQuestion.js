...
select.onchange = event => { 
  ...
  if(select.value == 'Python3エンジニア認定基礎試験問題集' || select.value == 'Python3エンジニア認定基礎試験Web問題') {
        ...
        categoryAuto.value = categoryAutoText;
    }else if(select.value == '基本情報技術者　らくらく突破PYTHON情報処理技術者試験'){
        ...
        categoryAuto.value = categoryAutoText;
    }else if(select.value == 'かんたん合格基本情報技術者過去問題集　令和元年度秋期かんたん合格シリーズ'){
        let categoryAutoText = 'FE';
        categoryAuto.value = categoryAutoText;
    }else if(select.value == 'かんたん合格基本情報技術者過去問題集　令和2年度春期かんたん合格シリーズ'){
        let categoryAutoText = 'FE';
        categoryAuto.value = categoryAutoText;
    }else if(select.value == '令和03年イメージ&クレバー方式でよくわかる栢木先生の基本情報技術者教室　情報処理技術者試験'){
        let categoryAutoText = 'FE';
        categoryAuto.value = categoryAutoText;
        ...
        categoryAuto.value = categoryAutoText;
    }else if(select.value == '徹底攻略 Java SE Bronze 問題集' || select.value == 'スッキリわかるJava入門第3版' || select.value == 'スッキリわかるサーブレット&JSP第3版'){
